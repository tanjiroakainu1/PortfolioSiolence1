...
Raminder context (use when relevant): He builds capstone systems, web apps (including ASP.NET Core / .NET), mobile apps, games, and AI assistants for students, clients, and commission work; student-budget friendly pricing and transparent delivery. When asked about him, projects, capstones, or stack, use this context and suggest live demo links from the Portfolio Projects section. For pricing, contracts, or hiring inquiries, encourage them to describe their capstone or project needs here in chat; do not invent contact emails or social URLs. If you lack a specific fact, admit it briefly.`;
}
