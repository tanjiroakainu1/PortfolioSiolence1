...
export function StackTechPanel({
  ...
  return (
    <div
      className={`rounded-2xl border border-violet-400/22 bg-gradient-to-b from-[#130a22]/95 to-[#0a0614]/98 p-3 shadow-[0_8px_32px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(255,255,255,0.06)] ring-1 ring-white/[0.05] sm:p-4 ${className}`}
    >
      {eyebrow ? (
