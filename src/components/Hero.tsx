...
export function Hero({ profile, assistant }: { profile: Profile; assistant: Assistant }) {
  return (
    <header className="portfolio-hero mb-[clamp(0.25rem,1vh,0.65rem)] border-b border-white/10 pb-[clamp(0.75rem,2vh,1.15rem)] pt-[clamp(0.15rem,0.8vh,0.4rem)] motion-safe:animate-envelope-letter-rise">
      <div className="relative overflow-hidden rounded-sm border border-white/10 bg-gradient-to-br from-violet-600/20 via-page/95 to-black/90 p-[clamp(0.85rem,2.5vw,1.15rem)] shadow-panel ring-1 ring-violet-600/25 backdrop-blur-[1.5px] sm:p-6">
        <div
        ...
        <div className="relative mx-auto flex w-full max-w-[36rem] flex-col items-center antialiased">
          ...
          <div className="mb-4 sm:mb-5">
            <div className="relative mx-auto w-fit">
              ...
              <img
                ...
                decoding="async"
                loading="eager"
                className="relative mx-auto block h-28 w-28 rounded-sm border border-violet-500/30 bg-surface object-cover object-[center_15%] shadow-[0_16px_48px_rgba(0,0,0,0.65),0_0_32px_rgba(168,85,247,0.25)] ring-2 ring-violet-600/30 sm:h-32 sm:w-32"
              />
            </div>
          </div>
          ...
          <p className="mt-2.5 w-full max-w-[34rem] text-balance bg-gradient-to-r from-violet-100/95 via-slate-100 to-violet-200/90 bg-clip-text px-2 text-center font-display text-[clamp(0.88rem,2.3vw,1.02rem)] font-medium leading-[1.42] tracking-[-0.01em] text-transparent sm:mt-3">
            {profile.tagline}
          </p>

          <div className="relative mt-5 w-full max-w-[34rem] sm:mt-6">
            <div
              className="pointer-events-none absolute left-0 top-1 bottom-1 w-[3px] rounded-full bg-gradient-to-b from-violet-400/75 via-violet-400/60 to-violet-400/50"
              aria-hidden
            />
            <div className="space-y-3.5 pl-4 font-hero text-[clamp(0.84rem,2.2vw,0.94rem)] leading-[1.62] tracking-[0.012em] sm:space-y-4 sm:pl-5 sm:text-[0.94rem]">
              <p className="m-0 text-left text-slate-200/92 [&::selection]:bg-violet-500/25">{profile.intro}</p>
              <p className="m-0 text-left font-medium text-slate-100/95 [&::selection]:bg-violet-500/25">
                {profile.introClosing}
              </p>
              <div className="rounded-xl border border-violet-400/32 bg-gradient-to-br from-accent/18 via-ion/12 to-violet-500/12 px-4 py-3.5 shadow-tile sm:px-5 sm:py-4">
                <p className="m-0 text-[0.97em] font-medium leading-[1.65] text-slate-200/95">{profile.cta}</p>
              </div>
            </div>
          </div>

          <section className="mt-6 w-full max-w-[34rem] rounded-2xl border border-violet-400/32 bg-gradient-to-br from-violet-500/12 via-page/88 to-violet-500/12 p-3.5 text-left shadow-[0_8px_28px_rgba(0,0,0,0.38),inset_0_1px_0_rgba(255,255,255,0.08)] sm:mt-7 sm:p-4">
            <div className="mb-4 flex w-full items-center gap-3">
              <span className="h-px min-w-[1.25rem] flex-1 bg-gradient-to-r from-transparent to-violet-400/50" aria-hidden />
              <h2 className="m-0 shrink-0 text-center font-display text-[clamp(0.68rem,1.9vw,0.76rem)] font-semibold uppercase tracking-[0.2em] text-violet-100/95">
                {profile.storyLead}
              </h2>
              ...
              {profile.developmentStories.map((story) => (
                ...
                >
                  ...
                  <p className="mt-2 mb-0 text-[0.83rem] leading-relaxed text-slate-300/95">
                    <span className="font-semibold text-violet-200">Core:</span> {story.context}
                  </p>
                  ...
                  <p className="mt-1.5 mb-0 text-[0.83rem] leading-relaxed text-slate-300/95">
                    <span className="font-semibold text-violet-200">Outcome:</span> {story.impact}
                  </p>
                </article>
              ))}
            </div>
