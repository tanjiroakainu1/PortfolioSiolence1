...
const assistantBubbleShell =
  "relative min-w-0 max-w-[min(100%,calc(100%-3rem))] overflow-hidden rounded-2xl rounded-tl-sm border border-action/30 bg-gradient-to-br from-action-deep/20 from-[0%] via-[#15101f]/96 via-[45%] to-action/10 to-[100%] px-3 py-2 leading-relaxed shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_6px_28px_rgba(0,0,0,0.4),0_0_32px_rgba(192,132,252,0.12)] ring-1 ring-action/15 [overflow-wrap:anywhere]";

const assistantBubbleSheen =
  "pointer-events-none absolute inset-0 rounded-[inherit] bg-[linear-gradient(125deg,rgba(192,132,252,0.14)_0%,transparent_38%,transparent_62%,rgba(147,51,234,0.1)_100%)] opacity-90";
...
export function ChatMessageThread({
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, rgba(192,132,252,0.06) 0%, transparent 36%), radial-gradient(ellipse 85% 55% at 100% 0%, rgba(147,51,234,0.1), transparent 52%), radial-gradient(ellipse 60% 40% at 0% 100%, rgba(16,185,129,0.05), transparent 50%), #0f0a18",
      }}
      role="log"
      aria-live="polite"
    >
