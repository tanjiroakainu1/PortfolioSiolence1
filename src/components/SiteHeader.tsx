...
export function SiteHeader({
  ...
  return (
    <header
      className={`site-header sticky top-0 z-[100] shrink-0 border-b border-white/10 bg-black/95 px-[var(--pad-x)] backdrop-blur-sm [--pad-x:clamp(0.75rem,3.5vw,1.5rem)] ${headerMode}`}
    >
