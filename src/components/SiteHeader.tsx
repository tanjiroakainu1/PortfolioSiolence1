...
export function SiteHeader({
  ...
  return (
    <header
      className={`site-header sticky top-0 z-[100] shrink-0 border-b border-violet-400/30 bg-page/95 px-[var(--pad-x)] backdrop-blur-sm [--pad-x:clamp(0.75rem,3.5vw,1.5rem)] ${headerMode}`}
    >
