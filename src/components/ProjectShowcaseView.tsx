...
export function ProjectShowcaseView({ hidden }: { hidden: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        <header className="showcase-hero mb-[clamp(1.35rem,4.2vw,2.25rem)] border-b border-red-500/15 pb-[clamp(1.1rem,3.2vw,1.65rem)] text-center sm:text-left">
        ...
        <div className="relative mx-auto mb-[clamp(1.25rem,3.5vw,2rem)] w-full max-w-[min(100%,40rem)] overflow-hidden rounded-[clamp(1rem,2.2vw,1.35rem)] border border-red-400/22 bg-gradient-to-b from-surface/55 via-page/40 to-[#141414]/90 p-[clamp(1rem,2.8vw,1.5rem)] shadow-[0_12px_48px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.07)] ring-1 ring-inset ring-white/[0.06] backdrop-blur-md sm:mx-0 sm:p-6 lg:max-w-[42rem]">
          <div
            ...
            aria-hidden
          />
          <p className="m-0 text-[clamp(0.62rem,1.8vw,0.68rem)] font-semibold uppercase tracking-[0.18em] text-red-200/90">
            ...
            {showcaseFacebookGridLinks.map((link, index) => (
              <li key={link.href} className="min-w-0">
                <a
                  ...
                  className="flex h-full min-h-[5.5rem] flex-col items-center justify-center gap-2.5 rounded-2xl border border-white/[0.08] bg-[#1a1a1a]/75 px-4 py-4 text-center no-underline shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] transition-[border-color,background-color,transform,box-shadow] duration-300 hover:-translate-y-0.5 hover:border-[#1877F2]/45 hover:bg-[#1877F2]/[0.08] hover:shadow-[0_12px_32px_rgba(0,0,0,0.35),0_0_28px_rgba(24,119,242,0.12)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-400/55 motion-reduce:transition-none motion-reduce:hover:translate-y-0"
                >
                  <span className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#1877F2]/25 to-[#0c64d4]/10 text-[#1877F2] shadow-[0_4px_16px_rgba(24,119,242,0.2)] ring-1 ring-[#1877F2]/30">
                    <span className="absolute -right-1 -top-1 flex h-5 min-w-[1.25rem] items-center justify-center rounded-md bg-page/95 px-1 text-[0.55rem] font-bold tabular-nums text-red-300 ring-1 ring-red-400/25">
                      {index + 1}
                    </span>
        ...
        >
          {projectShowcaseImages.map((item, i) => (
            <button
              ...
              className="group relative m-0 block w-full min-w-0 cursor-pointer overflow-hidden rounded-[clamp(0.9rem,2.2vw,1.125rem)] border border-white/[0.09] bg-[#1a1a1a]/90 p-0 text-left shadow-[0_4px_24px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.06)] ring-1 ring-red-400/[0.07] transition-[border-color,box-shadow,transform,ring-color] duration-300 hover:-translate-y-0.5 hover:border-action/35 hover:shadow-[0_20px_48px_rgba(0,0,0,0.45),0_0_36px_rgba(84,185,255,0.12),inset_0_1px_0_rgba(255,255,255,0.08)] hover:ring-action/25 active:translate-y-0 active:scale-[0.995] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-action/55 motion-reduce:transition-none motion-reduce:hover:translate-y-0 sm:rounded-2xl"
            ...
            >
              <div className="relative aspect-[4/3] w-full overflow-hidden min-[480px]:aspect-[16/10]">
                ...
                />
                <div
                  className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#141414]/55 via-transparent to-transparent opacity-80 transition-opacity duration-300 group-hover:opacity-100"
                  aria-hidden
                />
                <div
                  className="pointer-events-none absolute inset-0 ring-1 ring-inset ring-white/[0.06] transition-[box-shadow] duration-300 group-hover:shadow-[inset_0_0_0_1px_rgba(84,185,255,0.2)]"
                  aria-hidden
                />
              </div>
            </button>
